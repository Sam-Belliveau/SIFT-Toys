...
# === PARAMETERS ===
KERNEL = "thin_plate_spline"  # Options: multiquadric, thin_plate_spline, etc.


def create_interpolator(source_points, destination_points):
    """Create interpolator from point correspondences."""
    try:
...
def generate_warp_map(image_shape, source_points, destination_points):
    ...
    interpolator = create_interpolator(source_points, destination_points)
